...
# [VENDORED - local modification] Upstream used `sys.path.append("../")` +
# `from model.module import *`, which assumes `model/` is a top-level package.
# Converted to a package-relative import so this works as app.ml.kronos_src.model.
