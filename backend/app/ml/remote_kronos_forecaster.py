...
from app.ml.base import Forecaster, ForecasterError, ForecastResult
...
class RemoteKronosForecaster(Forecaster):
    ...
    def __init__(
        ...
        *,
        ...
        self.model_id = settings.kronos_model_id
        self.tokenizer_id = settings.kronos_tokenizer_id
        self.max_context = settings.kronos_max_context
    ...
    def forecast(self, df: pd.DataFrame, horizon: int) -> ForecastResult:
        ...
        last_date = pd.to_datetime(ctx.index[-1])
